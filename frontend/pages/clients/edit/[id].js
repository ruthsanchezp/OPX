...
export default function EditClient() {
  ...
  useEffect(() => {
    if (id) {
      ...
      if (!isNaN(parsedId)) {
        // Ya tienes un ID numérico seguro aquí
        axios
  ...
  const handleSubmit = (e) => {
    ...
    // Verificar que agreement_type esté presente y sea válido
    ...
    <div className="container mt-5">
      ...
      {client && (
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-3 row">
            <label htmlFor="id_fiscal" className="col-sm-2 col-form-label">
              ID Fiscal:
            </label>
            <div className="col-sm-10">
              <input
                ...
                onChange={(e) =>
                  setClient({ ...client, id_fiscal: e.target.value })
                }
                className="form-control"
              />
            </div>
          ...
          <div className="mb-3 row">
            <label htmlFor="agreement_type" className="col-sm-2 col-form-label">
              Convenio
            </label>
            <div className="col-sm-10">
              <input
                ...
                onChange={(e) =>
                  setClient({ ...client, agreement_type: e.target.value })
                }
                className="form-control"
              />
            </div>
